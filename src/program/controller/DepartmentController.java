...
import program.model.Department;
import program.model.Internship;
...
public class DepartmentController {
                        ...
                        return new ListCell<Internship>() {
                            ...
                            protected void updateItem(Internship item, boolean empty) {
                                ...
                                if (item != null) {
                                    ...
                                    try {
                                        String fxmlFile = "../../resources/fxml/dep_internship_list_element.fxml";
    ...
    private void displayAdBanner(Department department) {
        String fxmlFile = "../../resources/fxml/dep_ad_banner.fxml";
        FXMLLoader loader = new FXMLLoader(getClass().getResource(fxmlFile));
        try {
